...
class Results(ft.UserControl):
    ...
    def build(self):
        ...
        self.tx_VFM_percent = ft.Text("VFM(%): ", style=ft.TextThemeStyle.HEADLINE_SMALL)
        self.v_VFM_percent = ft.Text(VFM_percent, style=ft.TextThemeStyle.HEADLINE_SMALL)
        ...
        return ft.Card(
            content=ft.Container(
                content=ft.Column(
                    controls=[
                        ft.Column([
                        ft.Row([self.tx_PSC, self.v_PSC],alignment=ft.MainAxisAlignment.START), 
                        ft.Row([self.tx_LCC, self.v_LCC],alignment=ft.MainAxisAlignment.START),
                        ft.Row([self.tx_VFM, self.v_VFM],alignment=ft.MainAxisAlignment.START),
                        ft.Row([self.tx_VFM_percent, self.v_VFM_percent],alignment=ft.MainAxisAlignment.START)
                        ]),
                        self.graph,
                        lv,
                    ],
