...
class Results(ft.Stack):
    ...
    def build(self):
        ...
        PSC_res_df['year'] = str(PSC_res_df['year']).replace('00:00:00.000000','')
        LCC_res_df['year'] = str(LCC_res_df['year']).replace('00:00:00.000000','')
        SPC_res_df['year'] = str(SPC_res_df['year']).replace('00:00:00.000000','')
        SPC_check_df['year'] = str(SPC_check_df['year']).replace('00:00:00.000000','')
