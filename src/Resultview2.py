...
class Results(ft.Stack):
    ...
    #def build(self):
        ...
        final_inputs_df = final_inputs_df.drop(['growth', 'target_years', 'zei_total', 'yosantanka_hiritsu_shisetsu', 'yosantanka_hiritsu_ijikanri_1', 'yosantanka_hiritsu_ijikanri_2', 'yosantanka_hiritsu_ijikanri_3', 'pre_kyoukouka', 'first_end_fy', 'const_start_date_year', 'const_start_date_month', 'const_start_date_day','datetime', 'user_id', 'calc_id', 'houjinjuminzei_ritsu_todouhuken', 'houjinjuminzei_ritsu_shikuchoson', 'ijikanri_unnei_LCC', 'ijikanri_unnei_1_LCC', 'ijikanri_unnei_2_LCC','ijikanri_unnei_3_LCC','shisetsu_seibi_LCC', 'datetime', 'user_id', 'calc_id'], axis=1)
        ...
        # 最終入力・パラメータの表を作成
        #final_inputs_df = final_inputs_df.drop([], axis=1)
